...
namespace Transportation.DataAccess.FileManager
{
    public class FileService : IFileService
    {
        ...
        private static string[] GetAllowedExtensions(string folder) => folder switch
        {
            ...
            UploadFilesPath.Apps => new[] { ".apk", ".ipa", ".exe", ".msi" },
            UploadFilesPath.AppIcons => new[] { ".jpg", ".jpeg", ".png", ".webp", ".gif" },
        ...
        private static long GetMaxFileSize(string folder) => folder switch
        {
            ...
            UploadFilesPath.Apps => 500 * 1024 * 1024,  // 500MB
            UploadFilesPath.AppIcons => 2 * 1024 * 1024,    // 2MB
            _ => 10 * 1024 * 1024    // 10MB
        };
